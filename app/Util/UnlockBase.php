...
namespace App\Util;
	...
	*/
	...
	define('UNLOCKBASE_API_KEY', getenv('UNLOCKBASE_API_KEY'));
	...
	class UnlockBase
	{
		...
		*/
		...
		public static function ParseXML ( $XML )
		{
			...
			// array('UnlockBase','XML_Start')
			/* Configure the parser */
			$Parser = xml_parser_create('UTF-8');
			xml_set_element_handler($Parser, UnlockBase::XML_Start(), array('UnlockBase', 'XML_End'));
